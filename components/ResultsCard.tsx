...
export default function ResultsCard({ analysisResult }: ResultsCardProps) {if (!analysisResult?.report) {
    return (
      <div className="max-w-4xl mx-auto py-8">
        <Card className="border-2 border-red-100 rounded-xl shadow-lg">
          <CardHeader className="bg-red-50 border-b-2 border-red-100 p-6">
          ...
          <CardContent className="p-8">
            <p className="text-red-800">
              The analysis did not return any results. Please try again with a different report.
            </p>
          </CardContent>
        </Card>
      </div>
